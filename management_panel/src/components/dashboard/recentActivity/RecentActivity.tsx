...
import { RecentActivityHeader } from '@app/components/dashboard/recentActivity/RecentActivityHeader/RecentActivityHeader';
import { RecentActivityFeed } from '@app/components/dashboard/recentActivity/recentActivityFeed/RecentActivityFeed';
